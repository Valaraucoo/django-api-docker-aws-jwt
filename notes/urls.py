...
urlpatterns = [
    ...
    path('<int:pk>/bookmark/', views.BookmarkNoteView.as_view(),
         name='notes-bookmark'),
    path('<int:pk>/category/', views.CategoryNoteView.as_view(),
         name='notes-category'),
    ...
    path('payment/notification/', views.PaymentNotificationView.as_view(),
